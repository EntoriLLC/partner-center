...
try {
  ...
  if (! $adminAgentsGroup) {
    Write-Host -ForegroundColor Red "Unable to find AdminAgents group. Without this group Entori App cannot access client data without manual consent. Execution of the script will be halted"
    Exit
  }
...
Write-Host -ForegroundColor Green "Script complete, please update your Entori Partner Center settings to the following:"
